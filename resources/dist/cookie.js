...
/* harmony export */   "addClickTo": () => (/* binding */ addClickTo),
...
function addClickTo(selector, cb) {
...
function init() {
  ...
  var cookie = JSON.parse((0,tiny_cookie__WEBPACK_IMPORTED_MODULE_0__.getCookie)(this.config.cookieName)); // default consent
  ...
  Object.assign(this.config.gtag_consent, cookie); //_updateConsent(this.config);
...
function setupTemplate() {
  ...
  // update
  (0,_helper__WEBPACK_IMPORTED_MODULE_1__.addClickTo)('[data-cookiebar="update-consent"]', function (event) {
    return _updateConsentEvent(event, _this.config);
  }); // show modal

  (0,_helper__WEBPACK_IMPORTED_MODULE_1__.addClickTo)('[data-cookiebar="modal-show"]', function () {
    return _showModal(_this.config);
  }); // hide modal

  (0,_helper__WEBPACK_IMPORTED_MODULE_1__.addClickTo)('[data-cookiebar="modal-hide"]', function () {
    return (0,_helper__WEBPACK_IMPORTED_MODULE_1__.hide)(document.getElementById('cookiebar-modal'));
  });
  return this;
}
...
function _updateConsent(config) {
  ...
  (0,tiny_cookie__WEBPACK_IMPORTED_MODULE_0__.setCookie)(cookieName, JSON.stringify(gtag_consent), {
  ...
  (0,_helper__WEBPACK_IMPORTED_MODULE_1__.hide)(document.getElementById('cookiebar-banner'));
  (0,_helper__WEBPACK_IMPORTED_MODULE_1__.hide)(document.getElementById('cookiebar-modal'));
}

function _showModal(config) {
  var consents = config.gtag_consent; // check consent
  ...
  (0,_helper__WEBPACK_IMPORTED_MODULE_1__.show)(document.getElementById('cookiebar-modal'));
}
})();
