...
{{--<div x-data="cookiebar" x-show="showDialog"--}}
...
{{--<script src="/vendor/cookiebar/app.js" defer="defer" ></script>--}}
{{--<script>--}}
{{--    window.addEventListener('load', (event) => {--}}
{{--        // Settings--}}
{{--        CookiebarConfig.set({--}}
{{--            gtm_code: "{{ config('cookiebar.gtm_code', '') }}",--}}
{{--            advanced_cookie_name: "{{ config('cookiebar.cookie_name', '') }}",--}}
{{--            expirationInDays: {{ config('cookiebar.cookie_lifetime', '') }},--}}
{{--            gtag_consent: {--}}
{{--                ad_storage: 'denied',--}}
...
{{--            }--}}
{{--        })--}}
{{--        console.log(CookiebarConfig.get());--}}
{{--    });--}}
{{--</script>--}}
